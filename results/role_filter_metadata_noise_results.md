...
| missing_target_priority | scope_role_filter_bm25_metadata_text | 5/5 | 5/5 | 0 | 0 | 0 | 0 |
...
| target_metadata_corrupt | scope_role_filter_bm25_metadata_text | 3/5 | 4/5 | 2 | 0 | 1 | 0 |
...
| unrelated_block_policy | scope_role_filter_bm25_metadata_text | 5/5 | 5/5 | 0 | 0 | 0 | 0 |
| competing_policy | bm25_metadata_text | 0/5 | 1/5 | 5 | 0 | 0 | 4 |
| competing_policy | role_filter_bm25_metadata_text | 0/5 | 1/5 | 5 | 0 | 0 | 4 |
| competing_policy | scope_role_filter_bm25_metadata_text | 5/5 | 5/5 | 0 | 0 | 0 | 0 |
...
| clean | scope_role_filter_bm25_metadata_text | fresh_too_permissive_dosage_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| clean | scope_role_filter_bm25_metadata_text | fresh_overblocking_invoice_total_v2 | answer | target | answer | ok | no | no | no | no |
...
| clean | scope_role_filter_bm25_metadata_text | fresh_stale_superseded_vpn_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| clean | scope_role_filter_bm25_metadata_text | fresh_ambiguous_authority_export_v2 | block | target | block | ok | no | no | no | no |
...
| clean | scope_role_filter_bm25_metadata_text | fresh_paraphrase_no_keyword_access_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| missing_target_type | scope_role_filter_bm25_metadata_text | fresh_too_permissive_dosage_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| missing_target_type | scope_role_filter_bm25_metadata_text | fresh_overblocking_invoice_total_v2 | answer | target | answer | ok | no | no | no | no |
...
| missing_target_type | scope_role_filter_bm25_metadata_text | fresh_stale_superseded_vpn_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| missing_target_type | scope_role_filter_bm25_metadata_text | fresh_ambiguous_authority_export_v2 | block | target | block | ok | no | no | no | no |
...
| missing_target_type | scope_role_filter_bm25_metadata_text | fresh_paraphrase_no_keyword_access_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| wrong_target_type | scope_role_filter_bm25_metadata_text | fresh_too_permissive_dosage_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| wrong_target_type | scope_role_filter_bm25_metadata_text | fresh_overblocking_invoice_total_v2 | answer | target | answer | ok | no | no | no | no |
...
| wrong_target_type | scope_role_filter_bm25_metadata_text | fresh_stale_superseded_vpn_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| wrong_target_type | scope_role_filter_bm25_metadata_text | fresh_ambiguous_authority_export_v2 | block | target | block | ok | no | no | no | no |
...
| wrong_target_type | scope_role_filter_bm25_metadata_text | fresh_paraphrase_no_keyword_access_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| missing_target_priority | scope_role_filter_bm25_metadata_text | fresh_too_permissive_dosage_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| missing_target_priority | scope_role_filter_bm25_metadata_text | fresh_overblocking_invoice_total_v2 | answer | target | answer | ok | no | no | no | no |
...
| missing_target_priority | scope_role_filter_bm25_metadata_text | fresh_stale_superseded_vpn_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| missing_target_priority | scope_role_filter_bm25_metadata_text | fresh_ambiguous_authority_export_v2 | block | target | block | ok | no | no | no | no |
...
| missing_target_priority | scope_role_filter_bm25_metadata_text | fresh_paraphrase_no_keyword_access_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| target_metadata_corrupt | scope_role_filter_bm25_metadata_text | fresh_too_permissive_dosage_v2 | verify_first | distractor_value | verify_first | ok | yes | no | no | no |
...
| target_metadata_corrupt | scope_role_filter_bm25_metadata_text | fresh_overblocking_invoice_total_v2 | answer | target | answer | ok | no | no | no | no |
...
| target_metadata_corrupt | scope_role_filter_bm25_metadata_text | fresh_stale_superseded_vpn_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| target_metadata_corrupt | scope_role_filter_bm25_metadata_text | fresh_ambiguous_authority_export_v2 | block | distractor_expectation | verify_first | miss | yes | no | yes | no |
...
| target_metadata_corrupt | scope_role_filter_bm25_metadata_text | fresh_paraphrase_no_keyword_access_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| unrelated_block_policy | scope_role_filter_bm25_metadata_text | fresh_too_permissive_dosage_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| unrelated_block_policy | scope_role_filter_bm25_metadata_text | fresh_overblocking_invoice_total_v2 | answer | target | answer | ok | no | no | no | no |
...
| unrelated_block_policy | scope_role_filter_bm25_metadata_text | fresh_stale_superseded_vpn_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| unrelated_block_policy | scope_role_filter_bm25_metadata_text | fresh_ambiguous_authority_export_v2 | block | target | block | ok | no | no | no | no |
...
| unrelated_block_policy | scope_role_filter_bm25_metadata_text | fresh_paraphrase_no_keyword_access_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| competing_policy | scope_role_filter_bm25_metadata_text | fresh_too_permissive_dosage_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| competing_policy | scope_role_filter_bm25_metadata_text | fresh_overblocking_invoice_total_v2 | answer | target | answer | ok | no | no | no | no |
...
| competing_policy | scope_role_filter_bm25_metadata_text | fresh_stale_superseded_vpn_v2 | verify_first | target | verify_first | ok | no | no | no | no |
...
| competing_policy | scope_role_filter_bm25_metadata_text | fresh_ambiguous_authority_export_v2 | block | target | block | ok | no | no | no | no |
...
| competing_policy | scope_role_filter_bm25_metadata_text | fresh_paraphrase_no_keyword_access_v2 | verify_first | target | verify_first | ok | no | no | no | no |
